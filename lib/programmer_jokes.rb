class Programmers
    ...
    def initialize
        @jokes = ['We have 4 kinds of Developers:
            ...
            4. Ctrl+c and Ctrl+v Developer..😂😂😂😜😜',
            'Programmers are like God. We create defects and also kill them too.We spend the whole day fixing a defect, and the patch itself gives birth to a few more defects of its own. (Anonymous)',
    ...
    #need to create a method radomly reply quotes
end